...
<head>
    ...
    <title>PORTER - Ata Operacional 2026</title>
...
<body>
    ...
    <div id="login-screen">
        <div class="login-box">
            <div class="login-header">
                <h1><i class="fas fa-shield-alt"></i> PORTER</h1>
                <p>Ata Operacional 2026</p>
            </div>
            <div class="login-body">
                <div class="form-group">
                    <label for="login-user"><i class="fas fa-user"></i> Usuário</label>
                    <input type="text" id="login-user" class="form-control" placeholder="Digite seu usuário">
                </div>
                <div class="form-group">
                    <label for="login-pass"><i class="fas fa-lock"></i> Senha</label>
                    <input type="password" id="login-pass" class="form-control" placeholder="Digite sua senha">
                </div>
                <div class="form-group">
                    <label for="login-turno"><i class="fas fa-clock"></i> Turno</label>
                    <select id="login-turno" class="form-control">
    ...
    <div id="main-content" class="hidden">
        ...
        <div class="topbar">
            ...
            <div class="topbar-controls">
                <!-- Contact Button -->
                <button class="contact-btn" onclick="app.openContactModal()">
                ...
                <div id="online-users" onclick="app.toggleOnlineUsers()">
        ...
        <div class="content-wrapper">
            ...
            <div id="sidebar">
                <div class="sidebar-section">
                    <h4><i class="fas fa-building"></i> Condomínios</h4>
                    <div id="condo-list"></div>
                </div>
                
                <div class="sidebar-section">
                    <h4><i class="fas fa-chart-line"></i> Estatísticas</h4>
                    <div style="font-size: 0.9rem; color: var(--secondary);">
                        <div style="margin-bottom: 10px;">📊 ATAs: <span id="sidebar-ata-count">0</span></div>
                        <div style="margin-bottom: 10px;">📌 Fixas: <span id="sidebar-fixa-count">0</span></div>
                        <div style="margin-bottom: 10px;">🔧 OS: <span id="sidebar-os-count">0</span></div>
                    </div>
                </div>
                
                <div class="sidebar-section" id="admin-controls" style="display: none;">
                    <h4><i class="fas fa-user-shield"></i> Administração</h4>
                    <button class="btn btn-warning" onclick="app.openAdminPanel()" style="width: 100%; margin-top: 10px;">
            ...
            <div class="main-content">
                ...
                <div id="mood-check-container" class="mood-check-container hidden">
                    ...
                    <p>Selecione seu humor atual para a equipe</p>
                    <div id="mood-options" class="mood-options"></div>
                    <div id="mood-status" style="margin-bottom: 20px;"></div>
                    <button id="mood-submit-btn" class="btn" onclick="app.enviarMood()" disabled>
                        <i class="fas fa-paper-plane"></i> Enviar Sentimento
                    </button>
                    <div id="mood-result" class="hidden"></div>
                </div>
                
                <!-- Tabs -->
                <div class="tabs">
                    <button class="tab-btn active" onclick="app.switchTab('tab-ata', this)">
                        <i class="fas fa-clipboard-list"></i> ATAs
                        <span id="tab-count-ata" class="tab-count">0</span>
                    </button>
                    <button class="tab-btn" onclick="app.switchTab('tab-fixas', this)">
                        <i class="fas fa-thumbtack"></i> Informações Fixas
                        <span id="tab-count-fixas" class="tab-count">0</span>
                    </button>
                    <button class="tab-btn" onclick="app.switchTab('tab-os', this)">
                        <i class="fas fa-tools"></i> Ordens de Serviço
                        <span id="tab-count-os" class="tab-count">0</span>
                    </button>
                    <button class="tab-btn chat-tab" onclick="app.switchTab('tab-chat', this); app.marcarChatComoVisualizado();">
                        <i class="fas fa-comments"></i> Chat
                        <span id="chat-badge" class="tab-count" style="display: none;">0</span>
                    </button>
                ...
                <div id="tab-ata" class="tab-content">
                    <h3><i class="fas fa-clipboard-list"></i> Registro de Ocorrências</h3>
                    <p style="color: var(--gray); margin-bottom: 30px;">Registre aqui todas as ocorrências, incidentes e informações importantes</p>
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-row">
                            <div class="form-group">
                                ...
                                <select id="filter-condo" class="form-control">
                        ...
                        <div class="filter-buttons">
                            <button class="btn btn-success" onclick="app.aplicarFiltrosAtas()">
                        ...
                        <div id="filtros-ativos-ata" style="margin-top: 15px; font-size: 0.9rem; color: var(--secondary);"></div>
                    </div>
                    
                    <!-- Results Info -->
                    <div id="resultados-info-ata" style="margin-bottom: 20px;"></div>
                    
                    <!-- ATA List -->
                    <div id="ata-lista" class="ata-lista"></div>
                    
                    <!-- New ATA Form -->
                    <div style="margin-top: 40px; padding: 30px; background: #f8f9fa; border-radius: 15px;">
                        <h4><i class="fas fa-plus-circle"></i> Novo Registro</h4>
                        <div class="filter-row">
                            <div class="form-group">
                                <label>Condomínio *</label>
                                <select id="ata-condo" class="form-control" onchange="app.updateCity()" required>
                                    <option value="">Selecione um condomínio...</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Cidade</label>
                                <input type="text" id="ata-cidade" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label>Tipo</label>
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <select id="ata-status" class="form-control">
                                    <option value="Em andamento">Em andamento</option>
                                    <option value="Finalizado">Finalizado</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="ata-desc" class="form-control" rows="5" placeholder="Descreva detalhadamente a ocorrência..." required></textarea>
                        </div>
                        <div style="display: flex; justify-content: flex-end; gap: 15px;">
                            <button class="btn btn-clear" onclick="document.getElementById('ata-desc').value = ''">
                                <i class="fas fa-times"></i> Limpar
                            </button>
                            <button class="btn btn-success" onclick="app.saveAta()">
                ...
                <div id="tab-fixas" class="tab-content hidden">
                    <h3><i class="fas fa-thumbtack"></i> Informações Fixas</h3>
                    <p style="color: var(--gray); margin-bottom: 30px;">Informações importantes que devem permanecer fixadas para referência</p>
                    <div id="fixas-lista" class="ata-lista"></div>
                </div>
                
                <!-- OS Tab -->
                <div id="tab-os" class="tab-content hidden">
                    <h3><i class="fas fa-tools"></i> Ordens de Serviço</h3>
                    <p style="color: var(--gray); margin-bottom: 30px;">Crie e gerencie ordens de serviço para os condomínios</p>
                    
                    <!-- OS Filters -->
                    <div style="display: flex; gap: 10px; margin-bottom: 30px;">
                        <button class="btn btn-success" onclick="app.filtrarOSTodas()">
                            <i class="fas fa-list"></i> Todas
                        </button>
                        <button class="btn" onclick="app.filtrarOSGravidade('Baixa')" style="background: #27ae60; color: white;">
                            <i class="fas fa-info-circle"></i> Baixa
                        </button>
                        <button class="btn" onclick="app.filtrarOSGravidade('Média')" style="background: #f39c12; color: white;">
                            <i class="fas fa-exclamation-circle"></i> Média
                        </button>
                        <button class="btn" onclick="app.filtrarOSGravidade('Alta')" style="background: #e74c3c; color: white;">
                            <i class="fas fa-exclamation-triangle"></i> Alta
                        </button>
                        <button class="btn" onclick="app.filtrarOSGravidade('Emergência')" style="background: #8b0000; color: white;">
                            <i class="fas fa-bell"></i> Emergência
                        </button>
                    </div>
                    
                    <!-- OS List -->
                    <div id="os-lista" class="ata-lista"></div>
                    ...
                    <div style="margin-top: 40px; padding: 30px; background: #f8f9fa; border-radius: 15px;">
                        ...
                        <div class="filter-row">
                            <div class="form-group">
                                <label>Condomínio *</label>
                                <select id="os-condo" class="form-control" onchange="app.updateCityOS()" required>
                                    <option value="">Selecione um condomínio...</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Cidade</label>
                                <input type="text" id="os-cidade" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label>Gravidade *</label>
                                <select id="os-gravidade" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="os-desc" class="form-control" rows="5" placeholder="Descreva detalhadamente o serviço a ser realizado..." required></textarea>
                        </div>
                        <div class="form-group">
                            <label>E-mails para Envio</label>
                            <input type="text" id="os-emails" class="form-control" 
                                   placeholder="digite@email.com, outro@email.com (separados por vírgula)">
                            <small style="color: var(--gray);">Insira os e-mails separados por vírgula</small>
                        </div>
                        
                        <!-- Gravidade Preview -->
                        <div id="os-preview-prioridade" style="margin: 20px 0; padding: 15px; background: white; border-radius: 8px; display: none;">
                            <div style="display: flex; align-items: center; gap: 15px;">
                                <div id="os-preview-icone"></div>
                                <div>
                                    <div id="os-preview-gravidade" style="font-weight: bold; font-size: 1.1rem;"></div>
                                    <div id="os-preview-prazo" style="font-size: 0.9rem; color: var(--gray);"></div>
                                </div>
                            </div>
                        </div>
                        
                        <div style="display: flex; justify-content: flex-end; gap: 15px;">
                            <button class="btn btn-clear" onclick="document.getElementById('os-desc').value = ''">
                                <i class="fas fa-times"></i> Limpar
                            </button>
                            <button class="btn btn-success" onclick="app.saveOS()">
                                <i class="fas fa-paper-plane"></i> Criar Ordem de Serviço
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div id="tab-chat" class="tab-content hidden">
                    <h3><i class="fas fa-comments"></i> Chat da Equipe</h3>
                    <p style="color: var(--gray); margin-bottom: 30px;">Comunicação em tempo real entre os operadores</p>
                    
                    <div id="chat-admin-controls" style="margin-bottom: 20px; display: none;">
                        <button class="btn btn-danger" onclick="app.clearChat()">
                    ...
                    <div class="chat-container">
                        ...
                        <div class="chat-input-container">
                            <textarea id="chat-input" placeholder="Digite sua mensagem aqui... Pressione Enter para enviar, Shift+Enter para nova linha"></textarea>
                            <button id="chat-send-btn" onclick="app.sendChatMessage()">
                ...
                <div id="tab-presenca" class="tab-content hidden">
                    ...
                    <p style="color: var(--gray); margin-bottom: 30px;">Registro de logins e logoffs dos operadores</p>
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-row">
                            <div class="form-group">
                                ...
                                <select id="filter-presenca-operador" class="form-control">
                                    <option value="">Todos os operadores</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Data Início</label>
                                <input type="date" id="filter-presenca-inicio" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Data Fim</label>
                                <input type="date" id="filter-presenca-fim" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Turno</label>
                                <select id="filter-presenca-turno" class="form-control">
                        ...
                        <div class="filter-buttons">
                            <button class="btn btn-success" onclick="app.aplicarFiltrosPresenca()">
                                <i class="fas fa-search"></i> Aplicar Filtros
                            </button>
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            <thead>
                                <tr style="background: #f8f9fa; border-bottom: 2px solid #eee;">
                                    <th style="padding: 15px; text-align: left;">Operador</th>
                                    <th style="padding: 15px; text-align: left;">Turno</th>
                                    <th style="padding: 15px; text-align: left;">Data</th>
                                    <th style="padding: 15px; text-align: left;">Login</th>
                                    <th style="padding: 15px; text-align: left;">Logoff</th>
                                </tr>
                            </thead>
                            <tbody id="presenca-lista">
                                <!-- Histórico will be loaded here -->
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div id="notifications-panel" class="notifications-panel">
            <div style="padding: 20px; border-bottom: 1px solid #eee; display: flex; justify-content: space-between; align-items: center;">
                <h4 style="margin: 0;"><i class="fas fa-bell"></i> Notificações</h4>
                <button class="btn btn-sm btn-clear" onclick="app.clearNotifications()">
        ...
        <div id="comments-modal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><i class="fas fa-comments"></i> Comentários</h4>
        ...
        <div id="report-modal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><i class="fas fa-file-pdf"></i> Gerar Relatório (PDF)</h4>
                    <button class="modal-close" onclick="app.closeReportModal()">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Condomínio</label>
                        <select id="report-condo" class="form-control">
                            <option value="">Todos os condomínios</option>
                        </select>
                    </div>
                    <div class="filter-row">
                        <div class="form-group">
                            <label>Data Início</label>
                            <input type="date" id="report-data-inicio" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Data Fim</label>
                            <input type="date" id="report-data-fim" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Tipo de Relatório</label>
                        <select id="report-tipo" class="form-control">
                            <option value="atas">Apenas Ocorrências</option>
                            <option value="fixas">Apenas Informações Fixas</option>
        ...
        <div id="admin-modal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><i class="fas fa-user-shield"></i> Painel Administrativo</h4>
        ...
        <div id="contact-modal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button class="modal-close" onclick="app.closeContactModal()">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nome</label>
                        <input type="text" id="contact-name" class="form-control" placeholder="Seu nome">
                    </div>
                    <div class="form-group">
                        <label>E-mail</label>
                        <input type="email" id="contact-email" class="form-control" placeholder="seu@email.com">
                    </div>
                    <div class="form-group">
                        <label>Assunto</label>
                        <input type="text" id="contact-subject" class="form-control" placeholder="Assunto da mensagem">
                    </div>
                    <div class="form-group">
                        <label>Mensagem</label>
                        <textarea id="contact-message" class="form-control" rows="5" placeholder="Digite sua mensagem..."></textarea>
                    </div>
                    <div style="margin-top: 30px; display: flex; justify-content: flex-end; gap: 15px;">
                        <button class="btn btn-clear" onclick="app.closeContactModal()">Cancelar</button>
                        <button class="btn btn-success" onclick="app.sendContactMessage()">
    ...
    <script>
        const DATA = {
            condominios: [
                { n: "Condomínio Solaris", c: "São Paulo" },
                { n: "Edifício Horizonte", c: "Rio de Janeiro" },
                { n: "Residencial Primavera", c: "Belo Horizonte" },
                { n: "Condomínio Centro Empresarial", c: "Porto Alegre" },
                { n: "Edifício Ocean View", c: "Florianópolis" },
                { n: "Condomínio Alphaville", c: "Barueri" },
                { n: "Residencial dos Lagos", c: "Campinas" },
                { n: "Edifício Financial Center", c: "São Paulo" },
                { n: "Condomínio Green Valley", c: "Curitiba" },
                { n: "Residencial Bella Vista", c: "Salvador" }
            ],
            funcionarios: [
                { nome: "Administrador Sistema", user: "admin", pass: "admin123", role: "ADMIN" },
                { nome: "Carlos Silva", user: "carlos", pass: "123", role: "OPERADOR" },
                { nome: "Maria Santos", user: "maria", pass: "123", role: "OPERADOR" },
                { nome: "João Oliveira", user: "joao", pass: "123", role: "OPERADOR" },
                { nome: "Ana Pereira", user: "ana", pass: "123", role: "OPERADOR" }
            ]
        };
    </script>
...
========================================`;
            ...
            // 🔧 FUNÇÃO LOADCHAT CORRIGIDA - COM SCROLL AUTOMÁTICO
            loadChat() {
                ...
                // Salvar scroll position atual
                const scrollTopBefore = container.scrollTop;
                const scrollHeightBefore = container.scrollHeight;
                const wasScrolledToBottom = Math.abs((container.scrollHeight - container.clientHeight) - container.scrollTop) < 50;
                ...
                // 🔧 SCROLL CORRIGIDO - Apenas rolar para baixo se estava no final ou se é uma nova mensagem
                setTimeout(() => {
                    if (wasScrolledToBottom || chatCorrigido.length > 0 && !scrollHeightBefore) {
                        container.scrollTop = container.scrollHeight;
                    } else {
                        // Manter a posição anterior do scroll
            ...
            // 🔧 NOVAS FUNÇÕES PARA OS BOTÕES QUEBRADOS
            ...
            sendContactMessage() {
                ...
                // Salvar no histórico de e-mails
                ...
                emailsHistory.unshift(contactData);
                if (emailsHistory.length > 50) emailsHistory.pop();
                localStorage.setItem('porter_emails_history', JSON.stringify(emailsHistory));
                
                // Simular envio
                const mailtoLink = `mailto:sistema@porter.com?subject=${encodeURIComponent(`[CONTATO] ${subject}`)}&body=${encodeURIComponent(`Nome: ${name}\nE-mail: ${email}\n\nMensagem:\n${message}`)}`;
                window.open(mailtoLink, '_blank');
                
                this.closeContactModal();
                this.showMessage('Mensagem de contato preparada para envio!', 'success');
